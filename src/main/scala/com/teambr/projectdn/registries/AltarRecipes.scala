...
object AltarRecipes {
    ...
    def init(): Unit = {
        altarRecipes += new AltarRecipe(EnumAlterType.DAY, EnumAlterSubType.DAY, new ItemStack(Items.DIAMOND), new ItemStack(ItemManager.dayCrystal), 10.0F, 2)
        altarRecipes += new AltarRecipe(EnumAlterType.NEUTRAL ,EnumAlterSubType.DAY, new ItemStack(Items.EMERALD), new ItemStack(ItemManager.dayCrystal), 10.0F, 0)
        altarRecipes += new AltarRecipe(EnumAlterType.NIGHT, EnumAlterSubType.NIGHT, new ItemStack(Items.NETHER_STAR), new ItemStack(ItemManager.dayCrystal), 10.0F, -3)
        altarRecipes += new AltarRecipe(EnumAlterType.NEUTRAL, EnumAlterSubType.NIGHT, new ItemStack(Items.NETHER_WART), new ItemStack(ItemManager.dayCrystal), 10.0F, 1)
    }
